({
    buscarERenderizarCadeirasOcupadas: function(component) {
        ...
        var carregouComponente = component.get("v.assentosCarregados")
    ...
    validarCadeira : function(component, event){
    ...
    enviarFormulario : function(component,event){
    ...
    redirecionarParaListaDeExibicao : function(){
